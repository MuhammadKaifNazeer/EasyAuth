...
description: Welcome to the Easy Auth Quick Start Guide.
---

This guide will help you quickly integrate one of our pre-made authentication systems into your Next.js project. Follow the steps below to get started.
