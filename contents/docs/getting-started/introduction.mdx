---
title: Introduction
description: This page provides an overview of EasyAuth.
---

Easy Auth is your go-to solution for integrating authentication into your Next.js projects. Instead of a traditional library, Easy Auth offers a collection of pre-made authentication systems. These systems are designed to be seamlessly integrated by simply copying and pasting the code into your project, saving you time and effort.
